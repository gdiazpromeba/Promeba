GrillaAreasFuncionales = Ext.extend(Ext.grid.GridPanel, {
	constructor : function(config) {
		GrillaAreasFuncionales.superclass.constructor.call(this, Ext.apply({
			store : new Ext.data.Store({
        		...
        		reader : new Ext.data.JsonReader({
        		  ...
        		  fields : [
                    ...
                    {name : 'orden', type : 'int', allowBlank : false }
                  ]
        		}),
		        autoDestroy : true
	        }),
			...
			columns : [
              ...
              {header : 'Orden', dataIndex : 'orden', width : 50, sortable : true}
            ],
